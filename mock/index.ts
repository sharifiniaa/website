...
export const about = {
  message:
    "Software engineer with +5 years of experience. I've worked as a Front-End Developer since 2017 and enjoyed continuously developing, implementing, and adopting new technologies to maximize development efficiency and produce innovative applications. Currently working as a Front-End Developer at Tehran Internet(780).",
};
...
export const contactData = {
  section_info:
    'Either you have an inquiry about a potential project, a question about programming or whatever pops into your mind, drop me a message and I will get back to you as soon as possible.',
  personal_info: [
    // {
    //   title: 'آدرس',
    //   text: 'ایران، تهران',
